...
while True:
    ...
    while True:
        ...
        if selectmenu == 1:
            ...
            trial = 0
            while verify_pin != int(atm.checkPin() and trial < 3):
                print(str(trial) + ". This is just a check. (If your Pin is correct re-entered it! Thank You..)")
                while verify_pin != int(atm.checkPin() and trial < 3):
                    verify_pin = int(input("Pin Anda Salah, Silahkan masukkan pin anda: "))
                    trial += 1
                    print(trial)
